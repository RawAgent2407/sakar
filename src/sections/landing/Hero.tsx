  ...
  return (
    <>
      <section className="relative w-full h-auto min-h-[667px] md:min-h-0 md:h-[720px]">
        ...
        <div className="relative z-10 flex flex-col justify-center md:justify-between h-full px-4 sm:px-6 lg:px-8 pt-40 md:pt-48 pb-12 md:pb-16">
          {/* Overlay for better text readability on mobile */}
          <div className="absolute inset-0 bg-black/40 md:bg-transparent z-[-1] rounded-none" />
          
          {/* Main Content */}
          <div className="w-full max-w-screen-lg mx-auto">
            <div className="flex flex-col gap-4 text-left w-full max-w-md md:max-w-2xl ml-0">
              {(heroContent.tagline || badge) && (
                <div className="flex items-center justify-start w-fit bg-[#E50914] rounded-full px-4 py-1">
              ...
              {/* Main Heading */}
              <h1 className="text-white text-4xl sm:text-5xl lg:text-[60px] font-semibold leading-tight sm:leading-[1.1] font-['General_Sans'] w-full">
              ...
              {/* CTA Buttons */}
              <div className="flex flex-row gap-2 md:gap-4 mt-4 w-full">
          ...
          {/* Search Filters - Keep this in its original position */}
          <form onSubmit={handleSearch} className="w-full max-w-xs md:max-w-screen-lg mx-auto mt-4 md:mt-0">
            <div className="flex flex-col md:flex-row md:flex-wrap gap-2 md:gap-3 mb-3 md:mb-0 pt-0 md:pt-5">
              {/* Location */}
